                                        ...
                                        <div class="col-12 table-responsive">
                                            <table class="table table-hover table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>&#8377 <?php echo $deposit; ?></td>
                                                        <td>&#8377 <?php echo $withdrawal; ?></td>
                                                        <td>&#8377 <?php echo $Transfer; ?></td>
                                                        <td>&#8377 <?php echo $money_in; ?></td>
                                                    </tr>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>&#8377 <?php echo $rate_amt; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Total Balance:</th>
                                                        <td>&#8377 <?php echo $totalMoney; ?></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
